...
! function($) {
    ...
    Datepicker.prototype = {
        ...
        show: function(e) {
            ...
            //for customization DatePicker
            var $datepickerCustomClass = $(this.element).data('custom-class');
            ...
            setTimeout(function() {
                datepicker.addClass('open ' + $datepickerCustomClass);
            }, 170);
        },
    ...
    var DPGlobal = {
        ...
        dates: {
            ...
            daysMin: ["SU", "MO", "TU", "WE", "TH", "FR", "SA", "S"],
            months: ["JANUARY.", "FEBRUARY", "MART", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER"],
            monthsShort: ["January", "February", "Mart", "April", "May", "June", "July", "August", "September", "October", "November", "December"]
        },
